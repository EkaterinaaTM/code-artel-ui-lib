...
var CheckboxBase = function (props) {
    ...
    return (React.createElement(Input$1, __assign({ id: "checkbox-" + id, disabled: disabled, checked: checked, defaultChecked: defaultChecked, name: name, type: "checkbox", as: "input" }, rest)));
};
...
var RadioCheckboxBase = function (props) {
    ...
    return (React.createElement(Input$3, { id: "radiocheckbox-" + id, checked: checked, name: name, type: "radio", as: "input" }));
};
